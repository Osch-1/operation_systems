...
internal class OperatorState : AbstractState
{
    ...
    {
        _automate.StoreTokenInfo( new( TokenType.Operator, _automate.Position, _automate.Buffer, _automate.LineNumber ) );
    ...
    protected override void OnOperator()
    {
        ...
        if ( !IsValid() )
        {
            _automate.StoreTokenInfo( new( TokenType.Unknown, _automate.Position, _automate.Buffer, _automate.LineNumber ) );
            _automate.MoveCurrentPos();
            _automate.ClearBuffer();
