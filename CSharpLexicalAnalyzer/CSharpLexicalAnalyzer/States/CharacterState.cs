...
{    
    ...
    protected override void OnQuote()
    {
        ...
        TokenInfo tokenInfo = new( TokenType.Character, _automate.Position, _automate.Buffer, string.Join( ' ', _errors ) );
    ...
    protected override void OnEndOfLine()
    {
        ...
        TokenInfo tokenInfo = new( TokenType.Character, _automate.Position, _automate.Buffer, string.Join( Environment.NewLine, _errors ) );
